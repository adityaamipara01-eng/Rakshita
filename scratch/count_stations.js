...
const mapJsPath = path.join(__dirname, '..', '..', '..', '..', '..', 'HACKTHONE', 'rakshika', 'js', 'map.js');
...
// Let's write a quick regex/parse to extract the JSON-like array.
...
// Let's evaluate it using a safe mock or vm context, or simply eval since this is a local scratch script we wrote.
